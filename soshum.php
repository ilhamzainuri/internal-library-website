...
$kategori = isset($_GET['kategori']) ? mysqli_real_escape_string($koneksi, $_GET['kategori']) : 'Ilmu Sosial dan Humaniora';
...
<head>
    <meta charset="UTF-8">
    <title>Perpustakaan UNIGA - SosHum</title>
...
<nav>
    <ul>
      <li class="menu-category flex-grow-1">
        <form action="soshum.php" method="GET" class="d-flex">
          <!-- Input keyword -->
                    ...
                    <ul class="nav flex-column px-3">
                        ...
                        if (mysqli_num_rows($resultSub) > 0): ?>
                            <li class="nav-item mb-1">
                                <a class="nav-link fw-bold text-dark" href="soshum.php">Ilmu Sosial dan Humaniora</a>
                            </li>
                            <?php while ($sub = mysqli_fetch_assoc($resultSub)) : ?>
                                <li class="nav-item mb-1">
                                    <a class="nav-link text-dark" href="soshum.php?kategori=<?php echo urlencode($kategori); ?>&subkategori=<?php echo urlencode($sub['nama_subkategori']); ?>">
