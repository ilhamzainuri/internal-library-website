...
INSERT INTO `buku` (`bukuId`, `judul`, `penulis`, `jumlah_halaman`, `format`, `penerbit`, `tahun_terbit`, `eISBN`, `jumlah-buku`, `kategoriId`, `id_subkategori`, `rakId`, `gambar`, `sinopsis`) VALUES
